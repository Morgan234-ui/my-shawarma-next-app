...
const Contact = () => {
  ...
  <div className="contact-layout">
    ...
    <div className="card">
      ...
      <div className="info-row">
        ...
        <div>
          ...
          <p className="info-value">Mon – Fri, 9:00 AM – 9:00 PM</p>
      ...
      <div className="social-row">
        ...
        <a href="https://www.instagram.com/morgan_edache/" className="social-btn" aria-label="Instagram" target="_blank" rel="noopener noreferrer"><i className="ti ti-brand-instagram">
    ...
    <div>
      ...
      <a href="tel:+2348126201628,+2349050928447" className="contact-card">
        <div className="contact-card-icon"><i className="ti ti-phone"></i></div>
        <div>
          <p className="contact-card-label">Phone</p>
          <p className="contact-card-value">+234 812 620 1628</p>
        </div>
        <i className="ti ti-arrow-right contact-card-arrow"></i>
      </a>

      <a href="mailto:edachemorgan10@gmail.com" className="contact-card">
        <div className="contact-card-icon"><i className="ti ti-mail"></i></div>
        <div>
          <p className="contact-card-label">Email</p>
          <p className="contact-card-value">edachemorgan10@gmail.com</p>
        </div>
        <i className="ti ti-arrow-right contact-card-arrow"></i>
      </a>

      <a href="https://wa.me/2349050928447" className="contact-card" target="_blank">
